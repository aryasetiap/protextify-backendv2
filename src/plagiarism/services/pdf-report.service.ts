    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        doc
          ...
          .fontSize(10)
          .text('Laporan Analisis Plagiarisme', { align: 'right' });
        ...
        doc
          .fontSize(12)
          .font('Helvetica')
          .text(`Dikirim oleh: ${submission.student.fullName}`);
        doc.moveDown(2);
        ...
        doc
          ...
          .font('Helvetica-Bold')
          .fontSize(14)
          .text('Skor Plagiarisme Keseluruhan', 70, cardStartY + 20);
        ...
        doc
          ...
          .fontSize(12)
          .fillColor(this.COLORS.TEXT)
          .text('Detail Pengumpulan', leftColumnX, detailsStartY);
        doc
          .font('Helvetica')
          .fontSize(10)
          .fillColor(this.COLORS.SUBTLE_TEXT)
          .text(
            `Kelas: ${submission.assignment.class.name}`,
            leftColumnX,
            detailsStartY + 20,
          )
          .text(
            `Diperiksa Pada: ${plagiarismChecks.checkedAt.toLocaleString(
              'id-ID',
            )}`,
            leftColumnX,
            detailsStartY + 35,
        ...
        if (rawData && rawData.result) {
          doc
            ...
            .fontSize(12)
            .fillColor(this.COLORS.TEXT)
            .text('Metrik Utama', rightColumnX, detailsStartY);
          doc
            .font('Helvetica')
            .fontSize(10)
            .fillColor(this.COLORS.SUBTLE_TEXT)
            .text(
              `Total Kata: ${rawData.result.textWordCounts}`,
              rightColumnX,
              detailsStartY + 20,
            )
            .text(
              `Kata Terplagiasi: ${rawData.result.totalPlagiarismWords}`,
              rightColumnX,
              detailsStartY + 35,
            )
            .text(
              `Sumber Ditemukan: ${rawData.result.sourceCounts}`,
              rightColumnX,
              detailsStartY + 50,
            );
        }
        ...
        doc
          .font('Helvetica-Bold')
          .fontSize(16)
          .text('Analisis Konten', { underline: true });
        doc.moveDown();
        ...
        if (
          ...
          doc
            .font('Helvetica-Bold')
            .fontSize(16)
            .text('Sumber Terdeteksi', { underline: true });
          doc.moveDown();
          ...
          relevantSources.forEach((source) => {
            ...
            doc
              ...
              .font('Helvetica-Bold')
              .fontSize(11)
              .text(source.title || 'Judul Tidak Diketahui');
            doc
            ...
            doc
              ...
              .font('Helvetica')
              .text(
                `Skor Kecocokan: ${source.score.toFixed(
                  2,
                )}%  |  Kata Terplagiasi: ${source.plagiarismWords}`,
              );
            doc.moveDown(2);
          });
        }
